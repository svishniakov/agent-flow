      ...
      <div class="shell">
        ...
        <div class="hero-grid">
          <div>
            ...
            <h1>Orchestrator for agents.</h1>
            <p class="hero-copy">
              AgentFlow gives the main agent shared memory, roles, model/reasoning config, role skills, and verification. Subagents launch only after separate approval.
            </p>
            <div class="actions" aria-label="Primary actions">
              <a class="button primary" href="#install">Install <span>↓</span></a>
              <a class="button" href="#prompts">Prompts <span>→</span></a>
            </div>
            <div class="badges">
            ...
            <div class="diagram">
              ...
              <div class="diagram-inner">
                ...
                <article class="node work">
                  ...
                  <p>Model, reasoning, skills.</p>
                </article>
                <article class="node locked">
                  <small>gate</small>
                  <strong>Subagents</strong>
                  <p>Explicit request only.</p>
                </article>
                <article class="node done">
                  <small>done</small>
                  <strong>Verified</strong>
                  <p>Fresh evidence before answer.</p>
                </article>
              </div>
            </div>
          </div>
    ...
    <section id="contract">
      <div class="shell">
        <div class="section-head">
          ...
          <h2>Explicit invocation only.</h2>
          <p>AgentFlow is not preflight. It does not run automatically. Prefix does not authorize subagents.</p>
        </div>
        <div class="grid three">
          <article class="card">
            <div class="num">1</div>
            <h3>Invocation prefix</h3>
            <p><code>Agent Flow</code>, <code>$agent-flow</code>, or <code>agent-flow</code> at request start.</p>
          </article>
          <article class="card">
            <div class="num">2</div>
            <h3>Solo default</h3>
            <p>Short tasks stay solo. Orchestrator still owns scope and verification.</p>
          </article>
          <article class="card">
            <div class="num">3</div>
            <h3>Subagent gate</h3>
            <p>Delegation only after separate request: <code>use subagents</code>, <code>spawn a subagent</code>, <code>multi-agent review</code>.</p>
          </article>
        </div>
      </div>
    </section>
    ...
    <section id="inside">
      <div class="shell">
        <div class="section-head">
          ...
          <h2>Memory, roles, config.</h2>
          <p>Everything needed for routing lives in repo: role files, registry, references, scripts.</p>
        </div>
        <div class="grid four">
          <article class="card">
            <h3>Shared memory</h3>
          ...
          <article class="card">
            <h3>Orchestrator</h3>
            <p>Main agent chooses route, assigns roles, merges handoffs, verifies result.</p>
          </article>
          <article class="card">
            <h3>Role config</h3>
            <p><code>model</code>, <code>reasoning_effort</code>, <code>escalation_triggers</code> per role.</p>
          </article>
          <article class="card">
            <h3>Skills registry</h3>
            <p><code>registries/agent-skills.json</code> stores install metadata for role skills.</p>
          </article>
        </div>
      </div>
    </section>
    ...
    <section id="roles">
      <div class="shell">
        <div class="section-head">
          ...
          <h2>25 narrow roles.</h2>
          <p>Each role defines ownership, allowed tools, model config, skills, and expected handoff.</p>
        </div>
        <div class="role-grid">
    ...
    <section id="install">
      <div class="shell">
        <div class="section-head">
          ...
          <h2>Two commands.</h2>
          <p><code>--post-install</code> shows missing skills and recommends <code>core</code>. No silent install.</p>
        </div>
    ...
    <section id="prompts">
      <div class="shell">
        <div class="section-head">
          ...
          <h2>Short requests.</h2>
        </div>
        <div class="grid three">
          <div class="code-shell" data-copy-block>
            <button class="copy-button" type="button">Copy</button>
            <div class="terminal-title"><span class="lights"><i></i><i></i><i></i></span> solo</div>
            <pre><code>Agent Flow Read the repository, project memory, and README. Return active, blocked, next actions, risks. Do not change anything.</code></pre>
          </div>
          <div class="code-shell" data-copy-block>
            <button class="copy-button" type="button">Copy</button>
            <div class="terminal-title"><span class="lights"><i></i><i></i><i></i></span> bugfix</div>
            <pre><code>Agent Flow Investigate this bug: &lt;description&gt;. Find the cause, make the smallest fix, run checks, return changed files and risks.</code></pre>
          </div>
          <div class="code-shell" data-copy-block>
            <button class="copy-button" type="button">Copy</button>
            <div class="terminal-title"><span class="lights"><i></i><i></i><i></i></span> subagents</div>
            <pre><code>Agent Flow Use subagents for independent review. Split work by role and merge findings into one result.</code></pre>
          </div>
        </div>
      </div>
    </section>
