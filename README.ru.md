...
Вторая команда сообщает о недостающих скиллах и помогает настроить зависимости. Третья создаёт конфигурации специалистов для Codex. Повторите её после обновления файлов ролей скилла.
