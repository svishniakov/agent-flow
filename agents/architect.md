...
- Acceptance Criteria Traceability Gate and Surface Evidence Gate ids that QA/reviewer must prove through `acceptance-traceability.json`, `surface_expectations`, `surface`, `polarity`, and `proof_kind`
