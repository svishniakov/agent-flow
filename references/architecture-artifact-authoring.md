...
- Reviewer fills `Architecture Matrix Mismatches` and `Contract Drift` for every selected facet and capability; `Contract Drift` must cover Engineering Simplicity.
